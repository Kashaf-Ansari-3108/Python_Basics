...
#Load known faces
hermione_image = face_recognition.load_image_file("faces/hermione.jpg")
hermione_encoding = face_recognition.face_encodings(hermione_image)[0]

harry_image = face_recognition.load_image_file("faces/harry.jpg")
harry_encoding = face_recognition.face_encodings(harry_image)[0]

known_face_encodings = [hermione_encoding, harry_encoding]
known_face_names = ["Hermione", "Harry"]
